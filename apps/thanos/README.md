...
I also considered VictoriaMetrics because of its very low CPU and RAM requirements. However, VictoriaMetrics does not support storing data in an object store, and I prefer not to keep all metrics data locally in a pvc. This was the main reason why Thanos became the best choice for my setup.
